...
public class BookServiceImpl implements BookService {
    ...
    public List<String> findNotReleasedBookTitlesInYear(int year) {
        ...
        LocalDate upper=LocalDate.of(year,12,1);
    ...
    public int findCountOfBooksWithTitleLengthLongerThan(int titleLength) {
        return bookRepository.countBooksWithTitleLengthMoreThan(titleLength);
    }

    @Override
    public List<String> findBookInformationByGivenTitle(String title) {

        return bookRepository.findBookInformation(title)
                .stream()
